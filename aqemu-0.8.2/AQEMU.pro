######################################################################
# Automatically generated by qmake (2.01a) Fri Jul 2 15:50:36 2010
######################################################################

TEMPLATE = app
TARGET = APP
DEPENDPATH += . Embedded_Display
INCLUDEPATH += . Embedded_Display
...
SOURCES += About_Window.cpp \
           ...
           Embedded_Display/remoteview.cpp \
           Embedded_Display/vncclientthread.cpp \
           Embedded_Display/vncview.cpp

QT += xml core gui widgets network testlib
DEFINES += VNC_DISPLAY QTONLY Q_OS_FREEBSD

RESOURCES += ./oxygen_icons.qrc ./shared_images.qrc
TRANSLATIONS += Russian.ts German.ts Ukrainian.ts French.ts English.ts

LIBS += -L/Users/macbook2015/Desktop/brew/lib -lvncclient
